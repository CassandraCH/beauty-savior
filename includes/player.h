...
/**
 *\struct player
 *\brief Structure gérant les caractéristiques liées au joueur
 */
...
/*! \addtogroup Getter
*   \brief Ensemble des accesseurs du programme 
 * */
    ///@{
...
*   \brief Listes de toutes les méthodes liées au Collision
 * */
  ///@{ 
